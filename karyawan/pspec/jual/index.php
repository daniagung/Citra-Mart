                        ...
                        <div class="panel-body">
                            <form method="POST">
                                <input type="text" class="form-control" name="cari"
                                       placeholder="Masukan Nama Barang / Kode Barang">
                            </form>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-stripped">
                                <tr>
                                    ...
                                    <form method="POST" action="fungsi/tambah/tambah.php?jual=jual">
                                        ...
                                        <input type="hidden" value="<?php echo $_SESSION['karyawan']['id_member']; ?>"
                                               name="kasir">
                                        <input type="hidden" value="<?php echo date("j F Y, G:i"); ?>" name="tgl">
                                        <td>
                                            <button class="btn btn-success">Taruh</button>
                                        </td>
                                    </form>
                                </tr>
                            </table>
                                ...
                                <div id="kasirnya">
                                    <table class="table table-stripped">
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <a href="print.php?nm_member=<?php echo $_SESSION['karyawan']['nm_member']; ?>
